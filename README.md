...
- I am looking to collaborate on a project to model all sorts of things (urban growth, immigration, economy, wars, climate change, natural disasters) using cellular automata. Right now, the project is in [<a href="https:://github.com/MartijnWallage/Thales">this</a>](https://github.com/MartijnWallage/Thales) rather primitive state.
